...
public class MeepMeepTrajSeq{
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = autoVTrajectory(meepMeep);

        Image img = null;
        try {
            img = ImageIO.read(new File("MeepMeepTesting/src/main/java/com/example/meepmeeptesting/decode webfield.png"));
        } catch (IOException e) {
        }
    ...
    public void runOpMode() throws InterruptedException(){
        ...
        TrajectorSequence myTraj = driveTrajectorySequenceBuilder(startPose);
            .turn(pi/4)
