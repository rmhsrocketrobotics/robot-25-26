//public class MeepMeepSensorInput extends LinearOpMode {
//    private ColorSensor =hardwareMap.get(NormalizedColorSensor .class,"test_color");
//    boolean sensorButton= false;
//
//    @Override
...
private ColorSensor = colorSensor;
    public static void main(String[] args) {
        ...
        colorSensor = hardwareMap.get(ColorSenor.class, "colorSensor");
    }

        @Override
        public void getColor() {
            greenValue = colorSensor.green();
            purpleValue = colorSensor.purple();
            alphaValue = colorSensor.alpha(); //brightness
            targetValue = 100;
        }
...
//Getting color
    public enum ColorSensor(MeepMeep meepMeep){
        NormalizedColorSensor colorSensor;

        public void init(HarwareMap) {
            colorSensor = hardwareMap.get(HSVColorSensor.class, "colorSensor"); //replace the green with exact sensor name

        }

        public detectedColor getDetectedColor(Telemetry telemetry) {
            NormalizedRGBA colors = colorSensor.getNormalizedColors(); //fraction percentage of the color

            float normRed, normYellow, normGreen, normBlue, normYellow;
            normRed = colors.red/colors.alpha;
            normYellow = colors.yellow/colors.alpha;
            normGreen = colors.green/colors.alpha;
            normBlue = colors.blue/colors.alpha;
            normPurple = colors.purple/colors.alpha;

//            telemetry.addData("red", normRed);
//            telemetry.addData("yellow", normYellow);
//            telemetry.addData("green", normGreen);
//            telemetry.addData("blue", normBlue);
//            telemetry.addData("purple", normPurple);
            colorTelemetry();

            //calibrate here, write conditionals for hue values, then [return DetectedColor.COLORINALLCAPS]
...
//                            for (Vector2d position = newVector2d(40.5,37.7){
//                                    .lineTo(40.5,27.7)
//                            }
//                        }
//
