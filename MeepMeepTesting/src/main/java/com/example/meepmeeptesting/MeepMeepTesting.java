...
public class MeepMeepTesting {
    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = clusterNightPath(meepMeep);
    ...
    public static RoadRunnerBotEntity clusterNightPath(MeepMeep meepMeep) {
        double scrollConstant = 120 * 2;

        return new DefaultBotBuilder(meepMeep)

                // Set bot constraints: maxVel, maxAccel, maxAngVel, maxAngAccel, track width
                .setConstraints(40, 50, Math.toRadians(180), Math.toRadians(180), 14.5)
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(0, 60 + scrollConstant, Math.toRadians(90)))
                        .setTangent(3*pi/2)
...
//                        .splineToSplineHeading(new Pose2d(20, 60, pi), pi)
    ...
    public static RoadRunnerBotEntity sweepTest(MeepMeep meepMeep) {
        ...
        double launchToParkAngle = angleBetweenPoints(new Vector2d(56, 30 * flipConstant), launchPosition);
        ...
        return new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(61, 13.5 * flipConstant, Math.toRadians(180)))
                        ...
                        .setTangent(launchToParkAngle + pi)
                        .splineToConstantHeading(new Vector2d(56, 35 * flipConstant), launchToParkAngle + pi)
